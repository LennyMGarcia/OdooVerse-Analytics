...
def knn_precision_at_k(actual, recommended, k):
    try:
        ...
        log_error(f"Error en knn_precision_at_k: {str(e)}")
        return 0
...
def knn_recall_at_k(actual, recommended, k):
    try:
        ...
        log_error(f"Error en knn_recall_at_k: {str(e)}")
        return 0
...
def knn_mean_reciprocal_rank(actual, recommended):
    try:
        ...
        log_error(f"Error en knn_mean_reciprocal_rank: {str(e)}")
        return 0
...
def knn_ndcg_at_k(actual, recommended, k):
    try:
        ...
        log_error(f"Error en knn_ndcg_at_k: {str(e)}")
        return 0
...
def svd_precision_at_k(actual, recommended, k):
    try:
        ...
        log_error(f"Error en svd_precision_at_k: {str(e)}")
        return 0
...
def svd_recall_at_k(actual, recommended, k):
    try:
        ...
        log_error(f"Error en svd_recall_at_k: {str(e)}")
        return 0
...
def svd_mrr(predictions, actual, k=50):
    try:
        ...
        log_error(f"Error en svd_mrr: {str(e)}")
        return 0
...
def svd_ndcg_at_k(actual, recommended, k):
    try:
        ...
        log_error(f"Error en svd_ndcg_at_k: {str(e)}")
        return 0
